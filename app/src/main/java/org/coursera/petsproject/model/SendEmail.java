...
public class SendEmail extends AsyncTask<Void, Void, Void> {
    ...
    //Información del envio del email.
     ...
     * @param context, contenedor.
     * @param email, dirección de email para el envio.
     * @param subject, asunto del email a enviar.
     * @param message, cuerpo del email que se va a enviar.
     */
    ...
    protected Void doInBackground(Void... params) {
        ...
        session = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(UserEmailActivity.user.getEmail(), UserEmailActivity.user.getPassword());
                    }
                });
        ...
        try {
            ...
            mm.setFrom(new InternetAddress(UserEmailActivity.user.getEmail()));
            //Adding receiver
